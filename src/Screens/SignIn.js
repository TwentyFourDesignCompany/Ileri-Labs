  ...
  return (
    <div className="popup__container">
      <div className="popup__container__wrapper">
        <div className="popup__container__wrapper__heading">Sign In</div>
        <button
          onClick={() => {
            setIsSignIn(false);
          }}
          className="popup__container__wrapper__close__btn"
        >
          <svg
        ...
        <div className="popup__container__wrapper__content">
          <form className="login__form">
            ...
            <div className="login__form__row">
              ...
              <Link to="/" className="login__form__row__link">
                Forget Password?
              </Link>
            </div>
            <button
            ...
            <div className="signup__social__links">
              <Link to="/" className="signup__social__link">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="13.735"
                  height="25.644"
            ...
            <div style={{ marginTop: "3em" }}>
              ...
              <Link
                className="login__form__row__link"
                to="/sign-up"
                onClick={() => {
                  setIsSignIn(false);
                }}
